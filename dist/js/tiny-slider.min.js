var tns = (function () {
  ...
  function Pi(t) {
    var e = "";
    return (
      t.fake && ((e = n.style.overflow), (t.style.background = ""), (t.style.overflow = n.style.overflow = "hidden"), n.appendChild(t)), e
    );
  }
  function zi(t, e) {
    ...
    if (
      ...
      if (
        (I ||
          (function t(e) {
            for (var n in e)
              I || ("slideBy" === n && (e[n] = "page"), "edgePadding" === n && (e[n] = !1), "autoHeight" === n && (e[n] = !1)),
                "responsive" === n && t(e[n]);
          })(O),
        !I)
      ) {
      ...
      rt || an($t || ne),
        ...
        (function () {
          ...
          (_t += " tns-" + O.axis),
            (G.className += _t),
            I
              ? (((S = D.createElement("div")).id = Zt + "-mw"), (S.className = "tns-ovh"), j.appendChild(S), S.appendChild(V))
              : j.appendChild(V);
          if (gt) {
            var t = S || V;
            t.className += " tns-ah";
      ...
      if (
        ...
        Xe
          ...
          : O.autoplayButtonOutput &&
            (j.insertAdjacentHTML(cn(O.autoplayPosition), '<button data-action="' + t + '">' + Ke[0] + t + Ke[1] + At[0] + "</button>"),
      ...
      if (de) {
        if (Se)
          ...
          for (var e = "", n = ve ? "" : 'style="display:none"', i = 0; i < K; i++)
            e +=
              '<button data-nav="' + i + '" tabindex="-1" aria-controls="' + Zt + '" ' + n + ' aria-label="' + ze + (i + 1) + '"></button>';
      ...
      if (U) {
        ...
        if (
          ...
          if (
            e &&
            !H &&
            ((gt === autoheightTem && mt === speedTem) || Gn(), (ut === A && lt === E) || (V.style.cssText = pn(ut, lt, ot, mt, gt)), q)
          ) {
...
//# sourceMappingURL=https://cdnjs.cloudflare.com/ajax/libs/tiny-slider/2.9.2/min/tiny-slider.js
